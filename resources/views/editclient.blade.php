	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$results->client_name}}" name="clientName" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$results->contact_person}}" name="contactPerson" required>
                        <div class="invalid-feedback">  
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$results->address}}" name="address" required>
                        <div class="invalid-feedback">   
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$results->phone_number}}" name="phoneNumber" required>
                        <div class="invalid-feedback">  
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 offset-sm-2">
                        ...
                        <button type="click" id="clientAdd" class="btn btn-primary">Update</button>
                      </div>
                    </div>
