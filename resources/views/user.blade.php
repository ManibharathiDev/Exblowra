...
">
                                        <!-- <table id="example" class="table datatable table-striped table-bordered dt-responsive nowrap"> -->
                                        	...
                                        	<thead class="">
                                                <tr class="thead">
                                                	<th></th>
                                                    <th class="select-filter">User Name</th>
                                                    <th class="select-filter">Login ID</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="<?php echo $result->uid ?>">
                                                    ...
                                                    <a href="edituser/<?php echo $result->uid ?>"><span class="fa fa-pencil"></span></a></button>
                                                        <input type="hidden" name="user_no" value="{{$result->uid}}">
                                                        <button class="btn btn-danger btn-rounded btn-condensed btn-sm deleteRow" id="delete-{{$result->uid}}"><span class="fa fa-times"></span></button>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
    ...
    $('#'+row).addClass('selected');
        ...
        box.find(".mb-control-yes").on("click",function(){
            ...
            $.ajax({
                url: 'delete_user',
                type: 'POST',
                data: {'user_no' : row, '_token':$('input[name=_token]').val()},
                dataType: 'json',
