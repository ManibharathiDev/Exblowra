	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="form-group row">
                      <label class="col-sm-2 form-control-label">Job Name</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$results->job_name}}" name="jobName" required>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 offset-sm-2">
                        ...
                        <button type="click" id="jobAdd" class="btn btn-primary">Update</button>
                      </div>
                    </div>
